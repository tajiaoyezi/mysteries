...
## Purpose
定义release-sensitive验证、tag/version/revision一致性、双平台package、checksums、draft-to-public GitHub Release、公开下载smoke与归档门禁。
